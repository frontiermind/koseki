...
$thanksPage = "http://koseki-law.jp/thanks.php";
...
$refrom_name = " お問い合わせフォーム";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "小関法律事務所 | お問い合わせありがとうございました。";
...
小関法律事務所
TEL：03-3574-9401
E-mail: info@koseki-law.jp
URL:http://koseki-law.jp/index.html
──────────────────────
...
<meta name="keywords" content="koseki,小関法律事務所,小関,法律事務所,小関勇二,小関健二,新橋法律事務所"/>
<title>小関法律事務所</title>
</head>
<body class="body2 contact">
...
<div class="header">
	...
	<table class="header2">
		<tr>
			<td>
				<a href="/index.html"><img class="half" src="TopName2.png" /></a>
			</td>
			<td>
				<p class="header" >
					〒105-0004　東京都港区新橋2丁目21番1号　新橋駅前ビル2号館 7階<br/>
					TEL　 : 03-3574-9401 　　<br/>
					E-mail: info@koseki-law.jp
				</p>
			</td>
      ...
      <section class="page-content">
        ...
        <section class="page-block">
          ...
          <div class="page-section-inner">
          	<section class="page-block page-block_1col" id="contact">

          		<div class="page-block--contents">
          			<div class="l-container">
                          <div class="contact_box">
                <?php if($empty_flag == 1){ ?>
                 <p class="u-ta-c u-mb-20">入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</p>
                  <?php echo $errm; ?><br /><input class="form-reset" type="button" value=" 前画面に戻る " onClick="history.back()">
                  <?php }else{ ?>
          					<div class="product-attention">
                  		<p class="u-ta-c u-mb-20">内容をご確認の上、<br>送信ボタンを押してください。</p>
          					</div>
                <?php } ?>
                ...
                <?php }else{?>
                <form class="mailform" action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
          ...
          <?php echo confirmOutput($_POST);//入力内容を表示?>
                    ...
                    <button class="u-mt-30 u-mb-30 btn btn--submit" type="submit">送信する</button>
                  </div>
                </form>
          <?php } ?>
...
function confirmOutput($arr){
	...
	foreach($arr as $key => $val) {
		...
		if($out != "") {//これを追加
		$html .= '<dl class="form-content"><dt>'.$key.'</dt><dd>'.$out;
